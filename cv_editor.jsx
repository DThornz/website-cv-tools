...
const INITIAL_DATA = {
  ...
  sections: [
    ...
    {
      id: "publications", icon: "📄", title: "Publications", subtitle: "1 Patent · 1 Book Chapter · 9 Journal Articles", defaultOpen: true,
      subsections: [
        {
      ...
      subsections: [
        ...
        },
        {
          ...
          entries: [
            ...
            { id: uid(), year: "Feb 2024", title: "FSI Models of Early-Stage Calcified Aortic Valves", subtitle: "Mirza A, Ramaswamy S · Heart Day 2024, FIU", badges: [{ id: uid(), text: "🥇 1st Place Poster", type: "award" }], abstract: "", metaItems: [], links: [], images: [], videos: [], notes: "" },
    ...
    {
      id: "supervision", icon: "👥", title: "Supervision & Mentorship", subtitle: "3 Undergraduate Researchers · 19+ Senior Design Teams", defaultOpen: false,
      subsections: [
        {
