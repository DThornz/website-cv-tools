...
const INITIAL_DATA = {
  ...
  sections: [
      ...
      subsections: [
        {
          ...
          entries: [{
            ...
            subtitle: "Ramaswamy SD, Nevarez MP, <strong>Mirza AM</strong>, Lin Y-M, Ibarra A, Arman P. · Filed March 6, 2025",
            badges: [],
        ...
        },
        {
          ...
          entries: [{
            ...
            subtitle: "Ponce Aportela C, Alvarado D, Pandya K, Herrera A, <strong>Mirza A</strong>, Ramaswamy S. · Springer, Cham",
            badges: [],
        ...
        },
        {
          ...
          entries: [
            {
              id: uid(), year: "2026", title: "Computational Optimization of the Orbital Shaker Operational Parameters in Endothelial Mechanobiology",
              subtitle: "Muñoz E, Tsoukias NM, Alevriadou BR, …, <strong>Mirza A</strong>. · Annals of Biomedical Engineering. 2026",
              badges: [{ id: uid(), text: "Corresponding Author", type: "first" }, { id: uid(), text: "Senior/Last Author", type: "first" }],
              abstract: "First corresponding (senior/last) author work. CFD-driven optimization of orbital shaker operational parameters (rotational speed, fill volume, dish geometry) to prescribe well-defined wall shear stress conditions for endothelial mechanobiology experiments, enabling reproducible in vitro flow stimulation.",
              metaItems: [{ id: uid(), label: "DOI", value: "10.1007/s10439-026-04324-1" }],
              links: [{ id: uid(), text: "🔗 doi: 10.1007/s10439-026-04324-1", url: "https://doi.org/10.1007/s10439-026-04324-1" }],
              images: [], videos: [], notes: ""
            },
            {
              ...
              subtitle: "Xiao Z, White NA, Wen J, Postma RJ, Sol WMPJ, van den Berg BM, van Zonneveld AJ, van de Stadt HJF, <strong>Mirza A</strong>, Bijkerk R, Rotmans JI. · Acta Biomaterialia, 213:328-340. 2026 Mar",
              badges: [],
              ...
              metaItems: [{ id: uid(), label: "DOI", value: "10.1016/j.actbio.2026.01.044" }, { id: uid(), label: "PMID", value: "41587718" }],
            ...
            },
            {
              ...
              subtitle: "<strong>Mirza A</strong>, Hsu C-PD, Rodriguez A, … Ramaswamy S, Hutcheson JD. · Bioengineering, 11(10):955. 2024",
              ...
              metaItems: [{ id: uid(), label: "DOI", value: "10.3390/bioengineering11100955" }, { id: uid(), label: "PMID", value: "39451331" }],
            ...
            },
            {
              ...
              subtitle: "Xiao Z, Postma RJ, van Zonneveld AJ, van den Berg BM, Sol WMPJ, White NA, van de Stadt HJF, <strong>Mirza A</strong>, Wen J, Bijkerk R, Rotmans JI. · Materials Today Bio, 27:101121. 2024",
              badges: [],
              ...
              metaItems: [{ id: uid(), label: "DOI", value: "10.1016/j.mtbio.2024.101121" }, { id: uid(), label: "PMID", value: "38988818" }], links: [{ id: uid(), text: "🔗 doi: 10.1016/j.mtbio.2024.101121", url: "https://doi.org/10.1016/j.mtbio.2024.101121" }],
              images: [], videos: [], notes: ""
            },
            {
              ...
              subtitle: "<strong>Mirza A</strong>, Ramaswamy S. · Journal of Biomechanical Engineering, 144(11):114501. 2022",
              ...
              metaItems: [{ id: uid(), label: "DOI", value: "10.1115/1.4054630" }, { id: uid(), label: "PMID", value: "35599346" }], links: [{ id: uid(), text: "🔗 doi: 10.1115/1.4054630", url: "https://doi.org/10.1115/1.4054630" }],
              images: [], videos: [], notes: ""
            },
            { id: uid(), year: "2022", title: "Stem Cell-Secreted Allogeneic Elastin-Rich Matrix with Subsequent Decellularization for the Treatment of Critical Valve Diseases in the Young", subtitle: "Gonzalez BA, Herrera A, …, <strong>Mirza A</strong>, Ramaswamy S. · Bioengineering, 9(10):587. 2022", badges: [], abstract: "Bioreactor-based two-phase culture system in which hMSCs deposit elastin-rich ECM on PSIS scaffolds. Dynamically cultured scaffolds were decellularized to yield allogeneic ECM with ~8% elastin content, significantly enhancing collagen production by native valve interstitial cells in vitro.", metaItems: [{ id: uid(), label: "DOI", value: "10.3390/bioengineering9100587" }, { id: uid(), label: "PMID", value: "36290556" }], links: [{ id: uid(), text: "🔗 doi: 10.3390/bioengineering9100587", url: "https://doi.org/10.3390/bioengineering9100587" }], images: [], videos: [], notes: "" },
            { id: uid(), year: "2022", title: "Valve Endothelial Cell Exposure to High Levels of Flow Oscillations Exacerbates Valve Interstitial Cell Calcification", subtitle: "Hsu C-PD, Tchir A, <strong>Mirza A</strong>, … Hutcheson JD, Ramaswamy S. · Bioengineering, 9(8):393. 2022", badges: [], abstract: "Quantified role of oscillatory shear stress in driving maladaptive crosstalk between valve endothelial cells (VECs) and interstitial cells (VICs). VECs conditioned by highly oscillatory flow enhanced calcific signaling to VICs, underscoring the importance of flow-induced endothelial signaling in valvular disease.", metaItems: [{ id: uid(), label: "DOI", value: "10.3390/bioengineering9080393" }, { id: uid(), label: "PMID", value: "36004918" }], links: [{ id: uid(), text: "🔗 doi: 10.3390/bioengineering9080393", url: "https://doi.org/10.3390/bioengineering9080393" }], images: [], videos: [], notes: "" },
                        {
              ...
              subtitle: "Gonzalez B, Perez-Nevarez M, <strong>Mirza AM</strong>, Perez M, Ramaswamy S. · Frontiers in Cardiovascular Medicine, 7:69. 2020",
              ...
              metaItems: [{ id: uid(), label: "DOI", value: "10.3389/fcvm.2020.00069" }, { id: uid(), label: "PMID", value: "32509802" }], links: [{ id: uid(), text: "🔗 doi: 10.3389/fcvm.2020.00069", url: "https://doi.org/10.3389/fcvm.2020.00069" }],
              images: [], videos: [], notes: ""
            },
            {
              ...
              subtitle: "Mozneb M, <strong>Mirza AM</strong>, Li CZ. · Analytical Chemistry, 92(2):2244–2250. 2020",
              badges: [],
              ...
              metaItems: [{ id: uid(), label: "DOI", value: "10.1021/acs.analchem.9b04956" }, { id: uid(), label: "PMID", value: "31874559" }], links: [{ id: uid(), text: "🔗 doi: 10.1021/acs.analchem.9b04956", url: "https://doi.org/10.1021/acs.analchem.9b04956" }],
              images: [], videos: [], notes: ""
            },
            { id: uid(), year: "2019", title: "Elastin-Dependent Aortic Heart Valve Leaflet Curvature Changes During Cyclic Flexure", subtitle: "Tesfamariam MD, <strong>Mirza AM</strong>, Chaparro D, et al. · Bioengineering (Basel), 6(2):39. 2019", badges: [], abstract: "Linked elastin degradation to altered leaflet curvature under cyclic flexure — revealing a potential structural biomarker for early CAVD remodeling. Curvature mapping methodology developed and applied to both healthy and elastin-depleted tissue strips.", metaItems: [{ id: uid(), label: "DOI", value: "10.3390/bioengineering6020039" }, { id: uid(), label: "PMID", value: "31067726" }], links: [{ id: uid(), text: "🔗 doi: 10.3390/bioengineering6020039", url: "https://doi.org/10.3390/bioengineering6020039" }], images: [], videos: [], notes: "" },
          ]
        }
      ]
    },
      ...
      subsections: [
        {
          ...
          entries: [
            { id: uid(), year: "May 2026", title: "Computational Modeling of Aortic Valve Function", subtitle: "Mirza A · MCVI-FIU Mini Workshop: Innovations in Detection and Interventions in Aortic Stenosis, Miami Cardiac and Vascular Institute, Baptist Health South Florida, Miami, USA", badges: [{ id: uid(), text: "Invited Talk", type: "award" }], abstract: "Invited talk in the Enabling Technologies session of the MCVI-FIU Mini Workshop on Innovations in Detection and Interventions in Aortic Stenosis. Presented computational fluid-structure interaction and hemodynamic modeling approaches for aortic valve function, including WSS distributions and pathological morphology analysis relevant to aortic stenosis progression.", metaItems: [], links: [], images: [], videos: [], notes: "" },
    ...
    ,
        {
          ...
          entries: [
            ...
            {
              id: uid(), year: "2026", title: "1D Energy Transport Simulator",
              subtitle: "Educational tool · Heat Transfer / Numerical Methods · FIU BME",
              badges: [{ id: uid(), text: "Forward-Euler FDM · Thomas Solver", type: "first" }, { id: uid(), text: "Von Neumann Stability", type: "award" }],
              abstract: "Browser-based finite difference solver for the one-dimensional heat equation in Cartesian, cylindrical, and spherical coordinate systems. Implements explicit forward-Euler scheme with automatic Von Neumann stability enforcement (real-time Δt capping) and a tridiagonal Thomas algorithm for analytical steady-state profiles. Supports Dirichlet and Neumann boundary conditions with configurable thermal properties, domain length, and spatial resolution. Students observe transient temperature evolution with the analytical steady-state solution overlaid, reinforcing stability criteria, boundary condition effects, and geometry-dependent governing equations.",
              metaItems: [], links: [{ id: uid(), text: "🌡 Open Interactive Simulator", url: "https://dthornz.github.io/1D-Energy-Transport-Sim/" }, { id: uid(), text: "💾 GitHub", url: "https://github.com/DThornz/1D-Energy-Transport-Sim" }],
              images: [], videos: [], notes: ""
            },
            {
    ...
    {
      id: "supervision", icon: "👥", title: "Supervision & Mentorship", subtitle: "4 PhD Co-Mentees · 3 Undergraduate Researchers · 23+ Senior Design Teams", defaultOpen: false,
      subsections: [
        {
        ...
        },
        {
          ...
          entries: [
            {
              id: uid(), year: "Su 2026", title: "Summer 2026 Teams — Mentor (F6, F8) & Consulting Advisor (F2, F9)",
              subtitle: "Team F6: KneeHero (Mentor) · Team F8: Low-Volume Saliva Collection Device (Mentor) · Team F2: GyroFuse · Team F9: Aerosol Assist PRO",
              badges: [{ id: uid(), text: "Mentor — Teams F6 & F8", type: "role" }],
              abstract: "Team F6 — KneeHero: Pediatric Knee Extension Rehabilitation System\nRole: Mentor | Team: Juliana Facchini Mesa, Heaven Michel, Sawyer Herman, Sofia Martinez, Calvin Larkins\nA portable, low-profile knee extension rehabilitation device delivering controlled sustained stretch via a ratchet tension mechanism to treat pediatric post-ACL-reconstruction flexion contractures, paired with a gamified web app for adherence.\nContributions: Advised on 3D printing and device manufacturing; ran FEA drop-test simulations and pressure simulations to validate structural robustness; performed moment/force analysis of the cable routing to size the ratchet tensioning load path; supported JavaScript/HTML programming of the gamified rehabilitation web application; coordinated milestones and double-checked team progress.\n\nTeam F8 — Low-Volume Saliva Collection Device\nRole: Mentor | Team: Pablo Reyes, Elizabeth Turner, Valentina Vargas, Camila Barroso\nA passive, capillary-driven point-of-care device collecting 20–50 μL of saliva without absorbent materials, manual compression, or external power, integrating with Portable Diagnostic Systems' diagnostic interface.\nContributions: Provided 3D printing and manufacturability guidance for the five-component design; performed analytical fluid analysis of the capillary-driven mechanism using Jurin's Law to predict capillary rise and validate self-transport of the target 20–50 μL volume; coordinated milestones and double-checked team progress.\n\nTeam F2 — GyroFuse: Hybrid Anterior Lumbar Interbody Fusion (ALIF) Cage for Reduced Vertebral Subsidence\nRole: Consulting Advisor | Team: Emily Duenas, Pablo Boada, Kevin Del Valle, Julian Castillo\nA hybrid ALIF cage pairing a Ti-6Al-4V ELI gyroid-lattice core (60% porosity) with a bioactive nHA/PA66 sleeve to lower interface stiffness, reduce stress shielding, and promote osseointegration while carrying ≥2 kN structural loads.\nContributions: Advised on ANSYS structural simulations to investigate displacement and stress distributions across the implant and vertebral endplates, assessing overall vs. interface stiffness and stress-concentration hotspots per ASTM/ISO guidance.\n\nTeam F9 — Aerosol Assist PRO: An Aerosol Reduction Device for Pathogen Mitigation\nRole: Consulting Advisor | Team: Linda Urdaz, Jaylah Tuitt, Evanyss Jamero, Cecilia Santaella, Rene Rukimbira\nA dental aerosol-reduction device for pathogen mitigation operating under applied vacuum.\nContributions: Advised on a steady-state CFD analysis to identify stagnation regions arising under vacuum pressure that could impair drainage of particles, saliva, and water, informing geometry changes to eliminate recirculation dead zones.",
              metaItems: [], links: [], images: [], videos: [], notes: ""
            },
            { id: uid(), year: "Sp 2026", title: "Spring 2026 Teams — Mentor (F3) & Consulting Advisor (F5, F7, F8)", subtitle: "Team F3: IDD 2.0 (Mentor) · Team F5: FMT System · Team F7: ECMO Phantom · Team F8: RESTORE", badges: [{ id: uid(), text: "Mentor — Team F3", type: "role" }], abstract: "Team F3 — Wearable Postoperative Device for Mitigation of Capsular Contracture (IDD 2.0)\nRole: Mentor | Sponsor: Engineering Resources Group | Alumni Mentor: Alex Guillarte\nTeam: Maria Parra, Anthony Arenas, Maria C. Gonzalez, Ashley Simpson\nContributions: Breast bag inflation simulations; DOE framework for verification testing; ESP32 firmware and PCB coding; iterative product development.\n\nTeam F5 — Automated Processing System for Optimized Microbiota Extraction\nRole: Consulting Advisor | Faculty Mentor: Dr. Jessica Ramella-Roman | Sponsor: ARDIG\nTeam: Jennifer Boquin-Ciru, Natalie Hidalgo-Gato, Marco Garcia, Camila Jacome\nContributions: MATLAB parametric analysis of stool viscosity vs. RPM effects on WSS; structural/stress/deformation FEA of coupler mechanism; mesh convergence advising.\n\nTeam F7 — Phantom Model for Cannulation Devices in Stenotic Femoral Arteries\nRole: Consulting Advisor | Faculty Mentor: Dr. Joshua Hutcheson | Sponsor: CirculaTech\nTeam: Christopher Tarafa, Oscar Rosendo, Alejandra Arrazcaeta, Rachel Puerto\nContributions: CAD geometry prep; ANSYS Fluent meshing and initial setup; instruction on blood flow simulation in stenotic vessels.\n\nTeam F8 — RESTORE: Reduced Effort System for Tibia Orthopedic Removal and Extraction\nRole: Consulting Advisor | Faculty Mentor: Dr. Shuliang Jiao | Sponsor: Shukla Medical\nTeam: Gianella Escusel, Evan Gonzalez, Moshe Huaco, Jacob Motta\nContributions: Arduino motor driver CAM control programming; circuit setup and functional testing.", metaItems: [], links: [], images: [], videos: [], notes: "" },
            {
    ...
    },
    {
      ...
      subsections: [{
        id: uid(), title: "", defaultOpen: true,
        entries: [
          { id: uid(), year: "2026–2027", title: "Faculty Advisor — Alpha Eta Mu Beta (AEMB)", subtitle: "Biomedical Engineering Honor Society, FIU Chapter, Miami, FL", badges: [{ id: uid(), text: "Official Advisor", type: "role" }], abstract: "Official faculty advisor to FIU's chapter of Alpha Eta Mu Beta, the national biomedical engineering honor society.", metaItems: [], links: [], images: [], videos: [], notes: "" },
...
function generateCV(data) {
  ...
  const badge = (b) => {
    const cls = b.type === "first" ? "badge-first" : b.type === "co" ? "badge-co" : b.type === "role" ? "badge-role" : "badge-award";
...
.badge-role{background:var(--bg3);color:var(--text-muted);border:1px solid var(--border)}
